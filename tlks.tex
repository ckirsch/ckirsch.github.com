...
\begin{enumerate}
\item \emph{Take a Selfie: Self-Referentiality in the Automation of Everything}, ARGE Kulturelle Dynamiken, Vienna, January 2020.
\mytalkurl{ARGE20-Selfie}.

\item \emph{Take a Selfie in Class}, SPLASH-E Track on Computing Education, Boston, November 2018.
\mytalkurl{SPLASH-E18-Selfie}.

\item \emph{On the Self in Selfie}, SPLASH Workshop on Virtual Machines and Language Implementations (VMIL), Boston, November 2018.
\mytalkurl{VMIL18-Selfie}.

\item \emph{From Logical Execution Time to Principled Systems Engineering}, Dagstuhl Seminar on the Logical Execution Time Paradigm, Schloss Dagstuhl, Wadern, Germany, February 2018.
...
\begin{enumerate}
\item \emph{Quantum Advantage for All}, IFIP WG2.4 Workshop, Salzburg, Austria, July 2022.
\mytalkurl{IFIP22-Unicorn}.

\item \emph{Symbolic Execution Crash Course}, Czech Technical University, CVUT, Prague, February 2020.
\mytalkurl{CTU20-Symbolic-Execution-Crash-Course}.

\item \emph{On the Self in Selfie}, Universit{\'e} Diderot, IRIF, Paris, April 2019.
\mytalkurl{IRIF19-Selfie}.

\item \emph{On the Self in Selfie}, INESC-ID, Lisbon, Portugal, October 2018.
\mytalkurl{INESC18-Selfie}.

\item \emph{On the Self in Selfie}, Alpine Verification Meeting (AVM), Wagrain, Austria, September 2018.
\mytalkurl{AVM18-Selfie}.

\item \emph{Selfie: Towards Minimal Symbolic Execution}, ARC Group Meeting, UC Berkeley, Berkeley, California, July 2018.
\mytalkurl{UCB18-Selfie}.

\item \emph{Selfie: Towards Minimal Symbolic Execution}, VDS Workshop, Essaouira, Morocco, May 2018.
\mytalkurl{VDS18-Selfie}.

\item \emph{Selfie: Towards Minimal Symbolic Execution}, MoreVMs Workshop, Nice, France, April 2018.
\mytalkurl{MoreVMs18-Selfie}.

\item \emph{Self-Referential Compilation, Emulation, Virtualization, and Symbolic Execution with Selfie}, Lund University, Lund, Sweden, March 2018.
\mytalkurl{Lund18-Selfie}.

\item \emph{Self-Referential Compilation, Emulation, Virtualization, and Symbolic Execution with Selfie}, Google, Munich, Germany, March 2018.
\mytalkurl{Google18-Selfie}.

\item \emph{Selfie and the Basics}, University of Freiburg, Germany, November 2017.
\mytalkurl{Freiburg17-Selfie}.

\item \emph{Selfie and the Basics}, Onward!, Vancouver, British Columbia, October 2017.
\mytalkurl{Onward17-Selfie}.

\item \emph{Selfie: A Sandbox for Principled Systems Engineering}, ARM Research Summit, Cambridge, UK, September 2017.
